        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-gray-600">
              Need help? Visit the{' '}
              <Link href="/help" className="font-medium text-amazon-blue hover:text-blue-800">
                Help section
              </Link>{' '}
              or{' '}
              <Link href="/contact" className="font-medium text-amazon-blue hover:text-blue-800">
                contact us
              </Link>
            </p>
          </div>
